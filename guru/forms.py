...
class PasswordChangeForm(forms.Form):
    password_lama = forms.CharField(label='Old password', widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    password_baru = forms.CharField(label='New password', widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    konfirmasi_password = forms.CharField(label='Confirm new password', widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    ...
    def clean(self):
        ...
        if password_baru and konfirmasi_password and password_baru != konfirmasi_password:
