...
class SoalPgPanitia(forms.ModelForm):
    class Meta:
        model = Soal_pg
...
class SoalEsaiPanitia(forms.ModelForm):
    class Meta:
        model = SoalEsai
